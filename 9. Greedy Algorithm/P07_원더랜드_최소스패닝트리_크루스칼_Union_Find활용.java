...
public class P07_원더랜드_최소스패닝트리_크루스칼_Union_Find활용 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (Edge tmp : list) {
            ...
            // 정점의 개수가 V개인 경우, 트리 간선의 개수는 V-1개이다.
            // 만약 1000개의 도로 정보가 들어왔을 경우, 500번째에서 트리가 완성되었다면 나머지 500번은 확인해보지 않아도 된다.
            // 따라서 성능 개선을 위해 V-1개가 되었을 때 (=트리가 완성되었을 때) break; 를 걸어주면 효율적임 .. !
            if (count == V-1) {
                break;
            }
        }
